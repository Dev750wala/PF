...
const Left1 = () => {
  return (
    <div className='mb-20 bg-transparent'>
      <div className='mb-20 bg-transparent'>
        <h1 className="font-extrabold bg-transparent text-4xl pb-1 cursor-pointer">Dev Sadisatsowala</h1>
      ...
      <div className='bg-transparent lg:block hidden'>
        <h6 className='text-sm my-3 bg-transparent group'>
          <ScrollLink className='font-bold bg-transparent no-underline text-gray-400 group-hover:text-gray-200 cursor-pointer tracking-widest text-xs' to="about" duration={500} offset={-120}>ABOUT</ScrollLink>
        </h6>
        <h6 className='text-sm my-3 bg-transparent group'>
          <ScrollLink className='font-bold bg-transparent no-underline text-gray-400 group-hover:text-gray-200 cursor-pointer tracking-widest text-xs' to="skills" duration={500} offset={-190}>SKILLS</ScrollLink>
        </h6>
        <h6 className='text-sm my-3 bg-transparent group'>
