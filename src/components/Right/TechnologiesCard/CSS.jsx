...
const CSS = () => {
  return (
    <div className="w-20 h-20 bg-transparent bg-gray-300 flex items-center justify-center">
      <svg fill="#0170B8" className='bg-transparent' version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" height="100%" viewBox="0 0 512.00 512.00" enableBackground="new 0 0 512 512" xmlSpace="preserve" stroke="#0170B8">
